...
class Inception(nn.Module):
    def __init__(self,dropout=0.2):
        ...
        self.conv9x9 = nn.Sequential(
            ...
            nn.BatchNorm1d(16,eps=0.001),nn.Dropout(p=0.2))
        
        self.Module_incept=InceptionA(16,32)
    ...
    def forward(self, x):
            ...
            # x : 8 x 1 x 408
            out=act_fn(self.conv9x9(x))
            #out=self.dropout(out)
            
            out = self.Module_incept(out)
