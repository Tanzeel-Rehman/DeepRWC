...
from quantileloss import XTanhLoss  # Obselete TR: Nov_30_2019
...
from OneCycle_Policy import OneCycleLR
...
plt.figure()
Make_one_one_plot(model,train_X,train_Y)
Make_one_one_plot(model,val_X,val_Y)
